// ==UserScript==
// @name         Credamo 粘贴助手
// @namespace    https://sandyxu110.workers.dev
// @version      1.6
// @description  仅在页面存在 <input type="text"> 时显示按钮，粘贴内容到最后聚焦的文本框
// @author       feng + Copilot
// @match        https://www.credamo.com/answer.html*
// @updateURL    https://sandyxu110.workers.dev/en_paste.meta.js
// @downloadURL  https://sandyxu110.workers.dev/en_paste.user.js
// @grant        none
// ==/UserScript==
